...
//     if (SetupOperationalMode == 1 && IsInSetupMode == 0)
//     {
...
//         Serial.println(" not found please ensure you upload it!");
//         FilesystemOK = 0;
//     }
//     else
//     {
...
//         // Device Names
//         fSensorName1 = server.arg("fSensorName1");
//         Serial.println("Sensor Name1: " + fSensorName1);
//         fSensorName2 = server.arg("fSensorName2");
//         Serial.println("Sensor Name2: " + fSensorName2);
//         fSensorName3 = server.arg("fSensorName3");
//         Serial.println("Sensor Name3: " + fSensorName3);
//         fSensorName4 = server.arg("fSensorName4");
//         Serial.println("Sensor Name4: " + fSensorName4);
//         // Device IR Values
//         fSensorIR1 = server.arg("fSensorIR1");
//         Serial.println("Sensor Val IR1: " + fSensorIR1);
//         fSensorIR2 = server.arg("fSensorIR2");
//         Serial.println("Sensor Val IR2: " + fSensorIR2);
//         fSensorIR3 = server.arg("fSensorIR3");
//         Serial.println("Sensor Val IR3: " + fSensorIR3);
//         fSensorIR4 = server.arg("fSensorIR4");
//         Serial.println("Sensor Val IR4: " + fSensorIR4);

//         fSSID = server.arg("fSSID");
//         Serial.println("AP SSID: " + fSSID);
//         fPassword = server.arg("fPassword");
//         Serial.println("AP Password: " + fPassword);
